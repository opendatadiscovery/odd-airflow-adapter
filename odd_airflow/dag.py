...
from odd_airflow.settings import DATA_CATALOG_BASE_URL, AIRFLOW_UNIT_ID
...
class DAG(DAG):
    def __init__(self, *args, **kwargs):
        ...
        self.odd_api_client = ODDApiClient(base_url=kwargs.get('default_args', {}).get('data_catalog_base_url', DATA_CATALOG_BASE_URL))
    ...
    def _send_data(self, data: List[DataEntity]):
        ...
        try:
            r = self.odd_api_client.post_data_entity_list(request_data)
