...
# [START mysql_operator_howto_guide]
import datetime
...
# instantiating the mysql Operator
...
with DAG(
    ...
    catchup=False,
    default_args={
        "data_catalog_url": "http://host.docker.internal:8080/ingestion/entities",
        "unit_id": "my_airflow_unit_id"
    }
) as dag:
    # [START mysql_operator_howto_guide_create_pet_table]
    ...
    # [START mysql_operator_howto_guide_populate_pet_table]
    populate_pet_table = MySqlOperator(
    ...
    # [END mysql_operator_howto_guide_populate_pet_table]

    create_pet_table >> populate_pet_table
    # [END mysql_operator_howto_guide]